...
from data.matrix import matrix_generation
# from CAPE.CAPE_Final.data.matrix import matrix_generation
...
train_valid_name = "Ecoli_new_165"
testname1 = "trc_new_165" 
Update_Train = False
Update_Test1 = False
K_FOLD = 5
best_weight_dir1 = './best_Ecoli_new_165.pth'
best_weight_dir2 = './best_trc_new_165.pth'
...
def main():
    ...
    for F, (train_dataset, val_dataset) in enumerate(Task1_fold):
        ...
        model = PrompterModel(input_dim = in_dim,
                          ...
                          dropout_CNN = 0.2,
                          mat_size = CGR_N,
                          seq_len = train_dataset[0]['dna'].shape[0]
                          )
